                                   ...
                                   esp_lcd_panel_handle_t *ret_panel)
{
    ...
    case LCD_RGB_ELEMENT_ORDER_RGB:
        jd9365->madctl_val = 0x28; // Inicializar con rotación 270° (MV=1, MY=0, MX=1, ML=0, MH=1)
        break;
    case LCD_RGB_ELEMENT_ORDER_BGR:
        jd9365->madctl_val = 0x28 | LCD_CMD_BGR_BIT; // Rotación 270° con BGR
        break;
    default:
...
static const jd9365_lcd_init_cmd_t vendor_specific_init_default[] = {
    ...
    // Añadido para rotación 270°
    {0x36, (uint8_t[]){0x28}, 1, 0}, // MADCTL: MV=1, MY=0, MX=1, ML=0, MH=1 (270°)
};
